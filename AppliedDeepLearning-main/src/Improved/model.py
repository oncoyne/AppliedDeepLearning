...
class CNN(nn.Module):
    def __init__(self, height: int, width: int, channels: int):
        ...
        self.batch2d1 = nn.BatchNorm2d(num_features=self.conv1.out_channels)
        ...
        self.batch2d2 = nn.BatchNorm2d(num_features=self.conv2.out_channels)
        ...
        self.batch2d3 = nn.BatchNorm2d(num_features=self.conv3.out_channels)
        ...
        # nn.KLDivLoss requires log probabilites, hence Log softmax is used here
