...
parser.add_argument("--acc-frequency", 
                    default=10, 
                    type=int, 
                    help="How frequently to calcualte the accuracy on the validation set in number of epochs and output predictions"
                    )
...
def main(args):
    ...
    # Initialise loss function - KL Divergence Loss
