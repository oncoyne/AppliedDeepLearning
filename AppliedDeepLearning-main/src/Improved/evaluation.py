...
parser.add_argument('--gts', default="val.pkl")
...
def evaluate(preds_path, gts_path):
    ...
    print("ACCUARCY SCORES OF:", preds_path)
    print("-------------------------------------------------------------")
    print()
    print('CC: {}'.format(np.mean(cc_scores))) # CC
    print('AUC Borji: {}'.format(np.mean(auc_borji_scores))) # AUC Borji
    print('AUC Shuffled: {}'.format(np.mean(auc_shuffled_scores))) # Shuffled AUC
    print()
    print("-------------------------------------------------------------")
    print()

    return np.mean(cc_scores), np.mean(auc_borji_scores), np.mean(auc_shuffled_scores)

def main():
    evaluate(args.preds, args.gts)
